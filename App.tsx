    ...
    <div className="min-h-screen flex flex-col selection:bg-primary selection:text-white">
      ...
      <div className="fixed bottom-6 right-6 z-40">
        <button 
          ...
          className="bg-[#25D366] text-white p-4 rounded-full shadow-2xl flex items-center justify-center hover:scale-110 active:scale-95 transition-all group"
        ...
        >
          ...
          <span className="absolute right-full mr-3 bg-white text-[#111518] px-3 py-1 rounded-lg text-sm font-bold opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap shadow-xl border border-gray-100">
            ¿Necesitas ayuda?
          </span>
        </button>
      </div>
